...
namespace KTB.Controllers
{
    public class VendorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Vendor_Id,Vendor_Name,Nationality,DoB")] Vendor vendor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Vendor_Id,Vendor_Name,Nationality,DoB")] Vendor vendor)
        {
